      ...
      <main>
        ...
        >
          ...
          >
            ...
            <Box sx={{ width: "60%", padding: "20px", backgroundColor: colors.grass[10]}}>
            ...
            >
              <Typography tabIndex="0" variant="h4" gutterBottom>
                Faça Login
              </Typography>
              <form>
                <TextField
                ...
                <Button sx={{width: "100%"}} variant="contained" onClick={handleLogin}>
                  Entrar
                </Button>
                <Typography
                  sx={{ cursor: "pointer", marginTop: "10px", tabIndex: "0" }}
                  onClick={handleForgotPassword}
                >
                  Esqueceu a senha? Redefina aqui
                </Typography>
              </form>
              <Button sx={{ width: "100%", marginTop: "10px", marginRight: "45%" }}>
